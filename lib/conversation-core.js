...
module.exports = function setupConfig (configuration) {
  ...
  let {
    ...
    serviceName: wchServiceName = "wch_config"
  } = wchService;
  ...
  if (wchEnabled) {
    ...
    {
      packagePath: './lib/plugins/agendaactions',
      defaultLocale: defaultLanguage
    }];

    conversationmiddlewareConsumes.push('developeractionsMiddleware');
    conversationmiddlewareConsumes.push('agendaactionsMiddleware');
