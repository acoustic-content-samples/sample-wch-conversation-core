...
module.exports = function setup (options, imports, register) {
  if (!imports.wch) {
    throw new Error('Missing wch dependency');
  }
  ...
  let wchCacheConfig = {enabled: options.enableCache, ttl: options.ttl};
  let wchconversation = new WchConversationImpl(templateEngine, wchDelivery, wchHostUrl, wchCacheConfig);
